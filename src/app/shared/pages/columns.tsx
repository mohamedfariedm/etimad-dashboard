...
import FaqForm from './pages-form';
  ...
  },
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center gap-3">
        ...
        <DeletePopover
          title={`Delete Page`}
          description={`Are you sure you want to delete this #${row.id} Page?`}
      ...
      },
      {
        ...
        render: (_: string, row: any) => (row?.title?.[`${text_tr.ar}`]) 
      },
      {
        ...
        render: (_: string, row: any) => (row?.slug) 
      },
