...
import {
  CounrtyFormInput,
  CounrtyFormSchema,
} from '@/utils/validators/counrty-form.schema';
import { useCreateServices, useUpdateServices } from '@/framework/counrty';
...
export default function UpdateCreateBrand({
  ...
  const onSubmit: SubmitHandler<CounrtyFormInput> = (data) => {
    console.log(data);
    ...
    if (!isImageData) {
      ...
      if (initValues) {
        ...
        update({
          ...
          phone:data.phone,
          active: active,
          // show_in_home_page:show_in_home_page,
          // title: {
          //   en: data.titleEN,
          //   ar: data.titleAR,
          // },
  ...
  return (
    <>
      <Form<CounrtyFormInput>
        resetValues={reset}
        onSubmit={onSubmit}
        validationSchema={CounrtyFormSchema}
        useFormProps={{
          defaultValues: {
