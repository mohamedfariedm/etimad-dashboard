...
class Client {
  ...
  brands = {
    ...
    create: (input: any) => HttpClient.post('/Brand', input),
  ...
  counrty = {
    all: () => HttpClient.get(`/counrty`),
    create: (input: any) => HttpClient.post('/counrty', input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/counrty/${input.brand_id}`),
    update: (input:any) =>
      HttpClient.put(`/counrty/${input.brand_id}`, input),
  };

  Certificates = {
    all: (param:string) => HttpClient.get(`/OurService?type=${param}`),
    create: (input: any) => HttpClient.post('/OurService', input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/OurService/${input.brand_id}`),
    update: (input:any) =>
      HttpClient.put(`/OurService/${input.brand_id}`, input),
  };
  services = {
    all: () => HttpClient.get(`/OurService`),
    create: (input: any) => HttpClient.post('/OurService', input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/OurService/${input.brand_id}`),
    update: (input:any) =>
  ...
  registrationFormCategories = {
    all: () => HttpClient.get('/Company_register'),
    create: (input: any) => HttpClient.post('/Company_register', input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/Company_register/${input.brand_id}`),
    update: (input: any) =>
      HttpClient.put(`/Company_register/${input.id}`, input),
  };
  ...
  Companyregister = {
    all: () => HttpClient.get('/complaints'),
    single: (id: number) => HttpClient.get(`/complaints/${id}`),
    delete: (input: { brand_id: any }) =>
      HttpClient.delete(`/complaints/${input.brand_id}`),
  };
  ServiceDetails = {
    all: () => HttpClient.get('/service_page'),
    single: (id: number) => HttpClient.get(`/service_page/${id}`),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/service_page/${input.brand_id}`),
    update: (input:any) =>
      HttpClient.put(`/service_page/${input.brand_id}`, input),
  };
  Jobregister = {
    all: () => HttpClient.get('/Job-register'),
    single: (id: number) => HttpClient.get(`/Job-register/${id}`),
  };
  incubators = {
  ...
  clientReview = {
    ...
    create: (input: any) => HttpClient.post('/ClientReview', input),
    delete: (input: { brand_id: number[] }) =>
  ...
  trainingbox = {
    all: () => HttpClient.get('/news'),
    allCategory: () => HttpClient.get('/types'),
    create: (input: any) => HttpClient.post('/news', input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/news/${input.brand_id}`),
    update: (input:any) =>
      HttpClient.put(`/news/${input.brand_id}`, input),
  };
  type = {
    all: () => HttpClient.get('/types'),
    create: (input: any) => HttpClient.post('/types', input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/types/${input.brand_id}`),
    update: (input:any) =>
      HttpClient.put(`/types/${input.brand_id}`, input),
  };
  contacts = {
    all: () => HttpClient.get('/contacts'),
    delete: (input: { brand_id:any }) =>
      HttpClient.delete(`/contacts/${input.brand_id}`),
  };
  newsletterList = {
  ...
  pages = {
    ...
    allSingle: () => HttpClient.get(`${routes.pages.index}?type=pages`),
    ...
    editSlider: (input: any) =>
      HttpClient.put(`/pages/${input.section_id}`, input),
    create: (input: any) => HttpClient.post('/pages', input),
    updateAll: (input: any) => HttpClient.put(`/pages/${input.id}`, input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/pages/${input.brand_id}`),
    // allAgin: (param:string) => HttpClient.get(`/brands/index?${param}`),
  ...
  attachmentsService = {
    ...
    update: (input: any
    ) => HttpClient.put(`/sections/${input.id}`, input),
    updatePage: (input: {
      title: {};
      description?: {};
      attachment: any;
  ...
  menu = {
    all: () => HttpClient.get(`/menu`),
    create: (input: any) =>
      HttpClient.post('/menu', input),
    updateAll: (input: any) => HttpClient.put(`/menu/${input.id}`, input),
    delete: (input: { brand_id: number[] }) =>
      HttpClient.delete(`/menu/${input.brand_id}`),
  };
