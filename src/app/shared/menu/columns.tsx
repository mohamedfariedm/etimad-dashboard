    ...
    render: (_: string, row: any) => (
      <div className="flex items-center gap-3">
        ...
        <DeletePopover
          ...
          description={`Are you sure you want to delete this #${row.id} Menu Item?`}
      ...
      },
      {
        ...
        render: (_: string, row: any) => (row?.link?.[`${text_tr.ar}`]) 
      },
      {
        ...
        render: (_: string, row: any) => (row?.active==1?"Active":"Not Active") 
      },
