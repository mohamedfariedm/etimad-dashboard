...
import { getColumns } from '@/app/shared/news-box/columns-training-box';
import { Text } from '@/components/ui/text';
import toast from 'react-hot-toast';
import { useSearchParams } from 'next/navigation';
import { useDeletetraining } from '@/framework/training-box';
...
export default function ServiceTable({
  ...
  const { mutate: deleteBrand } = useDeletetraining();
