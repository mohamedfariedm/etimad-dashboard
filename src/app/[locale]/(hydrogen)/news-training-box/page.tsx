...
import ServicesForm from '@/app/shared/news-box/training-box-form';
import ServiceTable from '@/app/shared/news-box/table-training-box';
import Spinner from '@/components/ui/spinner';
import { useTraining } from '@/framework/training-box';
