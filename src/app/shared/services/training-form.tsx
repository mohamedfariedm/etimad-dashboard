...
import {
  ServiceTrainingFormInput,
  ServiceTrainingFormSchema,
} from '@/utils/validators/service-training-form.schema';
import { useCreateTraining, useUpdatetraining } from '@/framework/training';
...
export default function UpdateCreateBrand({
  ...
  const onSubmit: SubmitHandler<ServiceTrainingFormInput> = (data) => {
    console.log(data);
  ...
  return (
    <>
      <Form<ServiceTrainingFormInput>
        resetValues={reset}
        onSubmit={onSubmit}
        validationSchema={ServiceTrainingFormSchema}
        useFormProps={{
          defaultValues: {
